...
const MainLayout = ({
  ...
  return (
    <div className="flex justify-center bg-[#F9F9F9] pr-8 2xl:pr-0">
      <div className="flex min-h-screen max-w-[1497px]">
        {/* Sidebar */}
        ...
        {/* Content Area */}
        <div className="flex-1 flex flex-col h-screen overflow-hidden py-4 max-w-[1280px] mx-auto w-full">
